    ...
    def check_server_args(self):
        ...
        if not is_npu:
            ...
            if self.prefill_context_parallel_size > 1:
                ...
                assert (
                    self.chunked_prefill_size == None or self.chunked_prefill_size == -1
                ), "Context parallel is not compatible with chunked prefill."
            assert (
                self.tp_size * self.pp_size * self.prefill_context_parallel_size % self.nnodes == 0
